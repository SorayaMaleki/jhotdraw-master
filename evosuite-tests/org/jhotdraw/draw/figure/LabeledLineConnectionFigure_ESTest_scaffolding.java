...
public class LabeledLineConnectionFigure_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.jhotdraw.draw.figure.LabeledLineConnectionFigure"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LabeledLineConnectionFigure_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.jhotdraw.draw.connector.ChopEllipseConnector$1",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Comparator", false, LabeledLineConnectionFigure_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jhotdraw.draw.event.CompositeFigureListener", false, LabeledLineConnectionFigure_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LabeledLineConnectionFigure_ESTest_scaffolding.class.getClassLoader()); 
